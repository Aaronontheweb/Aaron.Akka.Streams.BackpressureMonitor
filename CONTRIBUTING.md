# Contributing to Aaron.Akka.Streams.BackpressureMonitor
...
If you add any new projects to the solution created with this template, be sure to add the following line to each one of them in order to ensure that you can take advantage of `Directory.Build.props` for standardization purposes:
